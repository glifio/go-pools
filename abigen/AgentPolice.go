...
// PrepareMinerForLiquidation is a paid mutator transaction binding the contract method 0xa643a7f8.
//
// Solidity: function prepareMinerForLiquidation(address agent, uint64 miner) returns()
func (_AgentPolice *AgentPoliceTransactor) PrepareMinerForLiquidation(opts *bind.TransactOpts, agent common.Address, miner uint64) (*types.Transaction, error) {
	return _AgentPolice.contract.Transact(opts, "prepareMinerForLiquidation", agent, miner)
}

// PrepareMinerForLiquidation is a paid mutator transaction binding the contract method 0xa643a7f8.
//
// Solidity: function prepareMinerForLiquidation(address agent, uint64 miner) returns()
func (_AgentPolice *AgentPoliceSession) PrepareMinerForLiquidation(agent common.Address, miner uint64) (*types.Transaction, error) {
	return _AgentPolice.Contract.PrepareMinerForLiquidation(&_AgentPolice.TransactOpts, agent, miner)
}

// PrepareMinerForLiquidation is a paid mutator transaction binding the contract method 0xa643a7f8.
//
// Solidity: function prepareMinerForLiquidation(address agent, uint64 miner) returns()
func (_AgentPolice *AgentPoliceTransactorSession) PrepareMinerForLiquidation(agent common.Address, miner uint64) (*types.Transaction, error) {
	return _AgentPolice.Contract.PrepareMinerForLiquidation(&_AgentPolice.TransactOpts, agent, miner)
}
