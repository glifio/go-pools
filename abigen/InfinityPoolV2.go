...
//
// Solidity: event Pay(uint256 indexed agent, uint256 amount, uint256 interest, uint256 principal, uint256 rate)
...
type InfinityPoolV2UpdateAccounting struct {
	Caller                          common.Address
	AccruedRentalFeesMarginal       *big.Int
	AccruedRentalFeesTotal          *big.Int
	PreviousAccountingUpdatingEpoch *big.Int
	ThisAccountingUpdateEpoch       *big.Int
	IFILPrice                       *big.Int
	Raw                             types.Log // Blockchain specific contextual infos
}

// FilterUpdateAccounting is a free log retrieval operation binding the contract event 0x5a23c4c84b820d04fba75b3f4c03c21e4e517bf06c34d138f831921da315f321.
//
// Solidity: event UpdateAccounting(address indexed caller, uint256 accruedRentalFeesMarginal, uint256 accruedRentalFeesTotal, uint256 previousAccountingUpdatingEpoch, uint256 thisAccountingUpdateEpoch, uint256 iFILPrice)
func (_InfinityPoolV2 *InfinityPoolV2Filterer) FilterUpdateAccounting(opts *bind.FilterOpts, caller []common.Address) (*InfinityPoolV2UpdateAccountingIterator, error) {
	...
	logs, sub, err := _InfinityPoolV2.contract.FilterLogs(opts, "UpdateAccounting", callerRule)
	if err != nil {
		return nil, err
	}
...
// WatchUpdateAccounting is a free log subscription operation binding the contract event 0x5a23c4c84b820d04fba75b3f4c03c21e4e517bf06c34d138f831921da315f321.
//
// Solidity: event UpdateAccounting(address indexed caller, uint256 accruedRentalFeesMarginal, uint256 accruedRentalFeesTotal, uint256 previousAccountingUpdatingEpoch, uint256 thisAccountingUpdateEpoch, uint256 iFILPrice)
func (_InfinityPoolV2 *InfinityPoolV2Filterer) WatchUpdateAccounting(opts *bind.WatchOpts, sink chan<- *InfinityPoolV2UpdateAccounting, caller []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _InfinityPoolV2.contract.WatchLogs(opts, "UpdateAccounting", callerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseUpdateAccounting is a log parse operation binding the contract event 0x5a23c4c84b820d04fba75b3f4c03c21e4e517bf06c34d138f831921da315f321.
//
// Solidity: event UpdateAccounting(address indexed caller, uint256 accruedRentalFeesMarginal, uint256 accruedRentalFeesTotal, uint256 previousAccountingUpdatingEpoch, uint256 thisAccountingUpdateEpoch, uint256 iFILPrice)
