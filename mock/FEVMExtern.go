...
func (_m *FEVMExtern) ConnectAdoClient(ctx context.Context) (jsonrpc.ClientCloser, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ConnectAdoClient")
	}
...
// ConnectEthClient provides a mock function with no fields
func (_m *FEVMExtern) ConnectEthClient() (*ethclient.Client, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ConnectEthClient")
	}
...
// ConnectLotusClient provides a mock function with no fields
func (_m *FEVMExtern) ConnectLotusClient() (*api.FullNodeStruct, jsonrpc.ClientCloser, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ConnectLotusClient")
	}
...
// GetEventsURL provides a mock function with no fields
func (_m *FEVMExtern) GetEventsURL() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetEventsURL")
	}
...
func NewFEVMExtern(t interface {
	mock.TestingT
	Cleanup(func())
}) *FEVMExtern {
	mock := &FEVMExtern{}
