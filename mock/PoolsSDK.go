...
// Act provides a mock function with no fields
...
// Extern provides a mock function with no fields
func (_m *PoolsSDK) Extern() types.FEVMExtern {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for Extern")
	}
