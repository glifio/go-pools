...
// PrepareMinerForLiquidation is a paid mutator transaction binding the contract method 0x6267b593.
//
// Solidity: function prepareMinerForLiquidation(uint64 miner, address liquidator) returns()
func (_Agent *AgentTransactor) PrepareMinerForLiquidation(opts *bind.TransactOpts, miner uint64, liquidator common.Address) (*types.Transaction, error) {
...
//
// Solidity: function prepareMinerForLiquidation(uint64 miner, address liquidator) returns()
func (_Agent *AgentSession) PrepareMinerForLiquidation(miner uint64, liquidator common.Address) (*types.Transaction, error) {
...
//
// Solidity: function prepareMinerForLiquidation(uint64 miner, address liquidator) returns()
func (_Agent *AgentTransactorSession) PrepareMinerForLiquidation(miner uint64, liquidator common.Address) (*types.Transaction, error) {
	return _Agent.Contract.PrepareMinerForLiquidation(&_Agent.TransactOpts, miner, liquidator)
}
